...
int menu_relatorio_dinamicos(void){
    ...
    printf("|                 4. Listar Agendamentos Ativos                          |\n");
    printf("|                 0. Voltar ao Menu Principal                            |\n");
    printf("|                                                                        |\n");
    printf("☽☉☾━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━☽☉☾\n");
    op_dados_filtro=escolha();
...
void escolha_relatorios_dinamicos(void){
    ...
    AgendamentoDinamico* lista_agendamentos;
    do{
        ...
        switch (op_dados_gerais){
            ...
            case 3:
                ...
                break;
            case 4:
                lista_agendamentos = carregar_agend_ativos();
                exibir_agend_ativos(lista_agendamentos);
                break;
            case 0:
                printf("           Voltando ao menu principal...\n");
                getchar();
...
int menu_relatorio_ordenados(void){
    ...
    printf("|                 4. Lista de Agendamentos ordenados pela Data           |\n");
    printf("|                 0. Voltar ao Menu Principal                            |\n");
    printf("|                                                                        |\n");
    printf("☽☉☾━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━☽☉☾\n");
    op_dados_filtro=escolha();
...
void escolha_relatorios_ordenados(void){
    ...
    do{
        ...
        switch (op_dados_gerais){
            ...
            case 4:
                lista_agendamentos = carregar_agend_ativos();
                exibir_agend_ordenados(lista_agendamentos);
                break;
            case 0:
                printf("           Voltando ao menu principal...\n");
                getchar();
